...
export function ProjectsSection() {
  const projects = [
    ...
    },
    {
      ...
      company: "Nadji.Bi Group SA — Mbour",
      description: 'Conception et développement d’un ensemble d’applications mobiles et du dashboard de supervision.Développement des applications Walalma Manager, Walalma Client et Walalma Caissier.',
    ...
    <section id="projets" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <Card className="group bg-black/50 border-white/10 overflow-hidden hover:border-emerald-500/50 transition-all duration-500">
                ...
                <div className="p-6">
                  ...
                  <h5 className="text-gray-400 italic">
                    {project.company}
                  </h5>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="text-2xl text-white text-center mb-8">Autres Projects</h3>
        </motion.div>
